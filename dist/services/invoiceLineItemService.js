...
function createInvoiceLineItem(invoiceLineItemData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const invoiceLineItem = yield invoiceLineItemModel_1.InvoiceLineItem.create(invoiceLineItemData);
...
function findInvoiceLineItemById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const invoiceLineItem = yield invoiceLineItemModel_1.InvoiceLineItem.findByPk(id);
            return invoiceLineItem;
        }
        catch (error) {
...
function findInvoiceLineItemsByInvoiceId(invoiceId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const invoiceLineItems = yield invoiceLineItemModel_1.InvoiceLineItem.findAll({ where: { invoiceId } });
...
function updateInvoiceLineItem(id, updateData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const invoiceLineItem = yield invoiceLineItemModel_1.InvoiceLineItem.update(updateData, { where: { id } });
            return invoiceLineItem;
        }
        catch (error) {
...
function deleteInvoiceLineItem(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield invoiceLineItemModel_1.InvoiceLineItem.destroy({ where: { id } });
            return result;
        }
        catch (error) {
