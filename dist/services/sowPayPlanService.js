...
const sowPayPlanModel_1 = require("../models/sowPayPlanModel");
function createPaymentPlan(paymentPlanData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const paymentPlan = yield sowPayPlanModel_1.PaymentPlan.create(paymentPlanData);
            return paymentPlan;
        }
        catch (error) {
...
function findPaymentPlanBySOWId(sowId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const paymentPlans = yield sowPayPlanModel_1.PaymentPlan.findAll({ where: { sowId } });
            return paymentPlans;
        }
        catch (error) {
...
function updatePaymentPlan(sowId, updateData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield sowPayPlanModel_1.PaymentPlan.update(updateData, { where: { sowId } });
...
function deletePaymentPlan(sowId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!paymentPlans)
                throw new Error('payment plans not found');
            yield sowPayPlanModel_1.PaymentPlan.destroy({ where: { sowId } });
...
function getClientPaymentPlans(customerId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const paymentPlans = yield sowPayPlanModel_1.PaymentPlan.findAll({ where: { customerId } });
            return paymentPlans;
        }
        catch (error) {
