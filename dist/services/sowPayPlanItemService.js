...
const sowPayPlanItemModel_1 = require("../models/sowPayPlanItemModel");
function createSowPaymentPlanItem(sowPaymentPlanItemData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const sowPaymentPlanItem = yield sowPayPlanItemModel_1.SowPaymentPlanItem.create(sowPaymentPlanItemData);
...
function findSowPaymentPlanItemsBySOWId(sowId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const sowPaymentPlanItems = yield sowPayPlanItemModel_1.SowPaymentPlanItem.findAll({ where: { sowId } });
...
function findSowPaymentPlanItemsByOrderId(orderId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const sowPaymentPlanItems = yield sowPayPlanItemModel_1.SowPaymentPlanItem.findAll({ where: { orderId } });
            return sowPaymentPlanItems;
        }
        catch (error) {
            console.error('error while finding sow payment plan items', error);
...
function updateSowPaymentPlanItem(id, updateData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const sowPaymentPlanItem = yield sowPayPlanItemModel_1.SowPaymentPlanItem.update(updateData, { where: { id } });
            return sowPaymentPlanItem;
        }
        catch (error) {
...
function deleteSowPaymentPlanItem(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield sowPayPlanItemModel_1.SowPaymentPlanItem.destroy({ where: { id } });
            return result;
        }
        catch (error) {
